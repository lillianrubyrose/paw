package enterprise_hello_world;
...
public class EnterpriseHelloWorld {
    ...
    private static EnterpriseHelloWorld instance;
    ...
    public static void instantiateHelloWorldMainClassAndRun() {
        instance = new EnterpriseHelloWorld();
    }

    public EnterpriseHelloWorld() {
        ...
        if (code.getStatusCode() != 0) {
            throw new RuntimeException(
                "Failed to print: " + code.getStatusCode()
            );
        }
    }
}
...
class HelloWorldImplementation implements IHelloWorld {
    ...
    public IStatusCode print(
        IPrintStrategy strategy,
        IHelloWorldString toPrint
    ) {
